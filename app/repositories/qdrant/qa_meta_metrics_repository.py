...
from app.entities.qdrant import QdMetaMetrics, QdMetaMetricsPayload
...
class MetaMetricsSemanticRepository:
    ...
    async def search(
        ...
        """按向量相似度检索指标元数据，并转换为 QdMetaMetrics 实体。"""
        ...
        return [
            QdMetaMetrics(
                ...
                payload=QdMetaMetricsPayload(**dict(point.payload or {})),
            )
