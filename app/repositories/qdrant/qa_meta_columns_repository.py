...
from app.entities.qdrant import QdMetaColumns, QdMetaColumnsPayload
...
class MetaColumnsSemanticRepository:
    ...
    async def search(
        ...
        """按向量相似度检索字段元数据，并转换为 QdMetaColumns 实体。"""
        ...
        return [
            QdMetaColumns(
                ...
                payload=QdMetaColumnsPayload(**dict(point.payload or {})),
            )
